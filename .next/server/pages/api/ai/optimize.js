"use strict";(()=>{var e={};e.id=285,e.ids=[285],e.modules={3872:e=>{e.exports=require("@clerk/nextjs/server")},1185:e=>{e.exports=require("mongoose")},145:e=>{e.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},2079:e=>{e.exports=import("openai")},6249:(e,t)=>{Object.defineProperty(t,"l",{enumerable:!0,get:function(){return function e(t,o){return o in t?t[o]:"then"in t&&"function"==typeof t.then?t.then(t=>e(t,o)):"function"==typeof t&&"default"===o?t:void 0}}})},7490:(e,t,o)=>{o.a(e,async(e,r)=>{try{o.r(t),o.d(t,{config:()=>u,default:()=>m,routeModule:()=>c});var s=o(1802),i=o(7153),a=o(6249),n=o(5627),p=e([n]);n=(p.then?(await p)():p)[0];let m=(0,a.l)(n,"default"),u=(0,a.l)(n,"config"),c=new s.PagesAPIRouteModule({definition:{kind:i.x.PAGES_API,page:"/api/ai/optimize",pathname:"/api/ai/optimize",bundlePath:"",filename:""},userland:n});r()}catch(e){r(e)}})},5627:(e,t,o)=>{o.a(e,async(e,r)=>{try{o.r(t),o.d(t,{default:()=>m});var s=o(1185),i=o.n(s),a=o(3872),n=o(2079),p=e([n]);let u=new(n=(p.then?(await p)():p)[0]).default({apiKey:process.env.OPENAI_API_KEY||"sk_test_YOUR_OPENAI_KEY_HERE"}),c=async()=>{try{1!==i().connection.readyState&&(await i().connect("mongodb+srv://hanouth21_db_user:dNJBNpN3VhskEzLX@cluster0.nncyczb.mongodb.net/taskManager?retryWrites=true&w=majority"),console.log("✅ MongoDB connected successfully"))}catch(e){throw console.error("❌ MongoDB connection failed:",e.message),e}},d=new(i()).Schema({name:{type:String,required:!0},completed:{type:Boolean,default:!1},priority:{type:String,enum:["low","medium","high"],default:"medium"},category:{type:String,enum:["work","personal","shopping"],default:"work"},userId:{type:String,required:!0,index:!0},createdAt:{type:Date,default:Date.now},updatedAt:{type:Date,default:Date.now}}),l=i().models.Task||i().model("Task",d);async function m(e,t){if(t.setHeader("Access-Control-Allow-Origin","*"),t.setHeader("Access-Control-Allow-Methods","POST, OPTIONS"),t.setHeader("Access-Control-Allow-Headers","Content-Type, Authorization"),"OPTIONS"===e.method)return t.status(200).end();if("POST"!==e.method)return t.status(405).json({error:"Method not allowed"});let{userId:o}=(0,a.getAuth)(e),r=o||"demo-user";if(!r)return t.status(401).json({error:"Unauthorized - Please sign in"});try{let e;if(!process.env.OPENAI_API_KEY||"sk_test_YOUR_OPENAI_KEY_HERE"===process.env.OPENAI_API_KEY)return t.status(200).json({optimizedTasks:[],suggestions:[{type:"priority",message:"\uD83E\uDD16 AI optimization requires OpenAI API key configuration",demo:!0},{type:"next_step",message:"\uD83D\uDCCB Focus on high-priority work tasks first",demo:!0},{type:"efficiency",message:"⚡ Group similar tasks together for better focus",demo:!0}],demo:!0});await c();let o=await l.find({userId:r}).sort({createdAt:-1});if(0===o.length)return t.status(200).json({optimizedTasks:[],suggestions:[{type:"empty",message:"\uD83D\uDCDD Add some tasks to get AI-powered optimization suggestions!",demo:!1}],demo:!1});let s=o.map(e=>({name:e.name,priority:e.priority,category:e.category,completed:e.completed})),i=`As a productivity expert, analyze these tasks and provide optimization:

Tasks:
${s.map((e,t)=>`${t+1}. ${e.name} (Priority: ${e.priority}, Category: ${e.category}, Completed: ${e.completed})`).join("\n")}
