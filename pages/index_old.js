...
export default function Home() {
  ...
  const [mounted, setMounted] = useState(true); // v2.0 - Fixed loading and darkMode issues
    ...
    <ErrorBoundary>
      <div style={{
          ...
          {toasts.map((toast) => (
            ...
            <div style={{
              ...
              <div style={{
                ...
                <h3 style={{ color: theme.text, marginBottom: '10px' }}>👤 User Info</h3>
                <p style={{ color: theme.text, opacity: 0.8 }}>Name: {user.name}</p>
                <p style={{ color: theme.text, opacity: 0.8 }}>Email: {user.email}</p>
              </div>
              ...
              <div style={{
                ...
                <h3 style={{ color: theme.text, marginBottom: '10px' }}>📊 Status</h3>
                <p style={{ color: theme.text, opacity: 0.8 }}>Tasks: {tasks.length}</p>
                <p style={{ color: theme.text, opacity: 0.8 }}>Database: {dbConnected ? 'Connected' : 'Offline'}</p>
              </div>
            </div>
        ...
        <div style={{
          ...
          {dbConnected ? '🟢 Connected to Database' : '🔴 Using Offline Mode'}
        </div>
      </div>
    </ErrorBoundary>
  );
